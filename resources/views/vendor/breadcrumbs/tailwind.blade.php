...
<div class="breadcrumbs">
    <nav class="flex px-5 py-3 my-4 text-gray-700 border border-gray-200 rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700 overflow-x-auto" aria-label="Breadcrumbs">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="{{ $breadcrumb->url && ! $loop->last ? $breadcrumb->url : '#' }}"
                           ...
                           @class([
                               ...
                               'hover:text-orange-600 dark:hover:text-white' => ! $loop->last,
