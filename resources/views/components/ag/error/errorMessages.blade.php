@if($message = Session::get('success'))
    <div class="bg-green-100 border-t-4 border-green-500 rounded text-green-900 px-4 py-3 shadow-md timeout my-4" role="alert">
        <div class="flex">
            <div class="py-1">
...
@if($message = Session::get('successError'))
    <div class="bg-red-100 border-t-4 border-red-500 rounded text-red-900 px-4 py-3 shadow-md timeout my-4" role="alert">
        <div class="flex">
            <div class="py-1">
...
@if($message = Session::get('warning'))
    <div class="bg-yellow-100 border-t-4 border-yellow-500 rounded text-yellow-900 px-4 py-3 shadow-md timeout my-4" role="alert">
        <div class="flex">
            <div class="py-1">
...
@if($message = Session::get('info'))
    <div class="bg-cyan-100 border-t-4 border-cyan-500 rounded text-cyan-900 px-4 py-3 shadow-md timeout my-4" role="alert">
        <div class="flex">
            <div class="py-1">
...
@if($errors->any())
    <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 timeout my-4" role="alert">
