<x-ag.header-admin current-text="" render="kundenCreate">
    {{-- <x-slot:headline>
     </x-slot:headline>--}}

    <div class="flex items-center justify-between pb-4">
        <span class="text-lg text-gray-500 md:text-xl dark:text-gray-400">{{ __('Add New Customers') }}</span>
        <div>
                ...
                <div id="AnschriftForm" >
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-2 place-content-start">
                        <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                            ...
                            <x-ag.input type="text" id="kunden.kd_kundennummer" wire:model.lazy="kunden.kd_kundennummer" placeholder="Kundennummer wird automatisch generiert" value="{{ old('kd_kundennummer') }}" disabled/>
                        </div>
                        <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-2 place-content-start">
                        ...
                        <div class="col-span-2">
                            ...
                            <x-ag.select id="kunden.kd_anrede" wire:model.lazy="kunden.kd_anrede">
                                @foreach(kundenSpecs()['anrede'] as $anrede)
                                    <option value="{{ old('kd_anrede', $anrede) }}">{{ $anrede }}</option>
                                @endforeach
                            </x-ag.select>
                        </div>
                        <div class="grid gap-4 col-span-2 grid-cols-2 place-content-start">
                            <div class="{{ ($kunden['kd_kundentype']) ? '' : 'hidden' }}">
                                ...
                                <x-ag.input type="text" id="kunden.kd_vorname" wire:model.lazy="kunden.kd_vorname" placeholder="Vorname / Ansprechpartner" value="{{ old('kd_vorname') }}" />
                            </div>
                            <div class="{{ ($kunden['kd_kundentype']) ? '' : 'col-span-2' }}">
                                <x-ag.label for="kunden.kd_name" text="Name / Firma" stern="true" />
                                <x-ag.input type="text" id="kunden.kd_name" wire:model.lazy="kunden.kd_name" placeholder="Name / Firma" value="{{ old('kd_name') }}" />
                            </div>
                        </div>
                        <div class="col-span-2">
                            <x-ag.label for="kunden.kd_zusatz" text="Zusatz" />
                            <x-ag.input type="text" id="kunden.kd_zusatz" wire:model.lazy="kunden.kd_zusatz" placeholder="Zusatz" value="{{ old('kd_zusatz') }}" />
                        </div>
                        <div class="col-span-2">
                            <x-ag.label for="kunden.kd_strasse" text="Straße" stern="true" />
                            <x-ag.input type="text" id="kunden.kd_strasse" wire:model.lazy="kunden.kd_strasse" placeholder="Straße" value="{{ old('kd_strasse') }}" />
                        </div>
                        <div class="grid grid-cols-2 gap-4 col-span-2">
                            <div>
                                <x-ag.label for="kunden.kd_plz" text="PLZ" stern="true" />
                                <x-ag.input type="number" id="kunden.kd_plz" wire:model.lazy="kunden.kd_plz" placeholder="PLZ" value="{{ old('kd_plz') }}" />
                            </div>
                            <div>
                                <x-ag.label for="kunden.kd_ort" text="Ort" stern="true" />
                                <x-ag.input type="text" id="kunden.kd_ort" wire:model.lazy="kunden.kd_ort" placeholder="Ort" value="{{ old('kd_ort') }}" />
                            </div>
                            <div class="col-span-2">
                                ...
                                <x-ag.select id="kunden.kd_land" wire:model.lazy="kunden.kd_land">
                                    @foreach(countryCode() as $countryCode)
                                        <option value="{{ old('kd_land', $countryCode['code']) }}">{{ $countryCode['name'] }}</option>
                                    @endforeach
                                </x-ag.select>
                            </div>
                        </div>
                ...
                <div id="KommunikationForm">
                    ...
                    <div class="grid gap-4 col-span-2 grid-cols-2 my-4 place-content-start">
                        <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                            ...
                            <x-ag.input type="tel" id="kunden.kd_telefon" wire:model.lazy.lazy="kunden.kd_telefon" placeholder="Telefon" value="{{ old('kd_telefon') }}" />
                        </div>
                        <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                            <x-ag.label for="kunden.kd_telefon_gesch" text="Telefon gesch." />
                            <x-ag.input type="tel" id="kunden.kd_telefon_gesch" wire:model.lazy.lazy="kunden.kd_telefon_gesch" placeholder="Telefon gesch." value="{{ old('kd_telefon_gesch') }}" />
                        </div>
                        <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                            <x-ag.label for="kunden.kd_fax" text="Fax" />
                            <x-ag.input type="tel" id="kunden.kd_fax" wire:model.lazy.lazy="kunden.kd_fax" placeholder="Fax" value="{{ old('kd_fax') }}" />
                        </div>
                        <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                            <x-ag.label for="kunden.kd_mobil" text="Mobil" />
                            <x-ag.input type="tel" id="kunden.kd_mobil" wire:model.lazy.lazy="kunden.kd_mobil" placeholder="Mobil" value="{{ old('kd_mobil') }}" />
                        </div>
                        <div class="col-span-2">
                            <x-ag.label for="kunden.kd_email" text="E-Mail" />
                            <x-ag.input type="email" id="kunden.kd_email" wire:model.lazy.lazy="kunden.kd_email" placeholder="E-Mail" value="{{ old('kd_email') }}" />
                        </div>
                        <div class="col-span-2">
                            <x-ag.label for="kunden.kd_webseite" text="Internetseite" />
                            <x-ag.input type="url" id="kunden.kd_webseite" wire:model.lazy.lazy="kunden.kd_webseite" placeholder="Internetseite" value="{{ old('kd_webseite') }}" />
                        </div>
                    </div>
                    ...
                    <div class="grid gap-4 col-span-2 grid-cols-3 my-4 place-content-start">
                        ...
                        <div class="flex flex-row flex-wrap gap-4 col-span-2">
                            <x-ag.checkbox type="checkbox" id="datenschutz.da_briefe" text="Briefe"/>
                            <x-ag.checkbox type="checkbox" id="datenschutz.da_telefon" text="Telefon"/>
                            <x-ag.checkbox type="checkbox" id="datenschutz.da_fax" text="Fax"/>
                            <x-ag.checkbox type="checkbox" id="datenschutz.da_mobile" text="Mobil"/>
                            <x-ag.checkbox type="checkbox" id="datenschutz.da_sms" text="SMS"/>
                            <x-ag.checkbox type="checkbox" id="datenschutz.da_whatsapp" text="WhatsApp"/>
                            <x-ag.checkbox type="checkbox" id="datenschutz.da_email" text="E-Mail"/>
            ...
            <div class="grid grid-cols-1 gap-4 mb-4">
                ...
                <div class="grid gap-4 col-span-2 grid-cols-2 mt-4 place-content-start">
                    <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                        ...
                        <x-ag.input type="text" id="kunden.kd_rabatt_artikel" placeholder="Rabatt auf Artikel in %" wire:model.lazy="kunden.kd_rabatt_artikel" value="{{ old('kd_rabatt_artikel') }}"/>
                    </div>
                    <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                        <x-ag.label for="kunden.kd_rabatt_arbeit" text="Rabatt auf Arbeit in %"/>
                        <x-ag.input type="text" id="kunden.kd_rabatt_arbeit" placeholder="Rabatt auf Arbeit in %" wire:model.lazy="kunden.kd_rabatt_arbeit" value="{{ old('kd_rabatt_arbeit') }}"/>
                    </div>
                    <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                        ...
                        <x-ag.select id="kunden.kd_zahlung" wire:model.lazy="kunden.kd_zahlung">
                            @foreach(kundenSpecs()['zahlungsbedingungen'] as $zahlungsbedingungen)
                                <option value="{{ old('kd_zahlung', $zahlungsbedingungen) }}">{{ $zahlungsbedingungen }}</option>
                            @endforeach
                        </x-ag.select>
                    </div>
                    <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                        ...
                        <x-ag.select id="kunden.kd_preisgruppe" wire:model.lazy="kunden.kd_preisgruppe">
                            @foreach(kundenSpecs()['preisgruppe'] as $preisgruppe)
                                <option value="{{ old('kd_preisgruppe', $preisgruppe) }}">{{ $preisgruppe }}</option>
                            @endforeach
                        </x-ag.select>
                    </div>
                    <div class="xl:grid-cols-2 xl:col-span-1 col-span-2">
                ...
                <div class="grid gap-4 col-span-2 grid-cols-2 place-content-start">
                    ...
                    <div>
                        ...
                        <x-ag.input type="text" id="kunden.kd_ust_id_nr" placeholder="USt - Identifikationsnummer" wire:model.lazy="kunden.kd_ust_id_nr" value="{{ old('kd_ust_id_nr') }}"/>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-1 gap-4 mb-4">
                ...
                <div class="grid gap-4 col-span-2 grid-cols-2 mb-4 place-content-start">
                    <div class="col-span-2">
                        <x-ag.textarea id="kunden.kd_anmerkungen" label="hidden" text="&nbsp;" content="{{ old ('kunden.kd_anmerkungen')}}"/>
                    </div>
                </div>
            </div>
