<x-ag.header-admin current-text="Artikel anlegen" render="artikelCreate">
    {{--<x-slot:headline>
    </x-slot:headline>--}}
                    ...
                    <div class="grid grid-cols-1 gap-4 place-content-start">
                        @if($formStep === 1)
                            <div>
                                ...
                                <x-ag.form.form-select-inline id="artikel.art_einheit" text="Einheit" stern="true" class-label="sm:basis-1/4" class-input="sm:basis-3/4">
                                    <option value=""></option>
                                ...
                                <x-ag.form.form-select-inline id="warengruppe.id" text="Warengruppe" stern="true" class-label="sm:basis-1/4" class-input="sm:basis-3/4">
                                    <option value=""></option>
                            ...
                            <div>
                                ...
                                <x-ag.form.form-select-inline id="artikel.art_mwst" text="MwSt" stern="true" class-label="sm:basis-1/4" class-input="sm:basis-3/4">
                                ...
                                <table class="w-full">
                                    ...
                                    @for($i = 1; $i <= 5; $i++)
                                        <tr>
                                            ...
                                            <td class="p-1 w-1/4">
                                                <div class="mt-1 text-right">{{ marge($preises['pr_prg_'.$i.'_netto_vk'], $preises['pr_brutto_ek']) }}</div>
                                            </td>
                                        </tr>
                                    @endfor
                                    </tbody>
