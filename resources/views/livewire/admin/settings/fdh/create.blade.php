<div class="px-4 py-3 bg-gray-50 rounded shadow-md dark:bg-gray-800">
    ...
    <div class="grid grid-cols-1 gap-4 mb-4 lg:grid-cols-3">
        ...
        <div>
            ...
            <x-ag.input type="text" id="fdh_tsn" wire:model="fdh_tsn" class=" uppercase" placeholder="TSN" />
        </div>
        <div>
    ...
    <div class="grid grid-cols-1 gap-4 mb-4">
        <div class="flex justify-end items-center">
            <x-ag.buttonLink wire:loading.remove wire:click="import" type="button" icon-left="fa-file-import" class="mr-4" text="Import"/>
            <x-ag.buttonLink wire:loading.remove wire:click="store()" icon-left="fa-save" text="Speichern"/>
        </div>
    ...
    @else
        <div class="grid grid-cols-1 gap-4 mb-4">
            <form wire:submit.prevent="importUpload">
                <div wire:loading.remove>
                    <x-ag.label for="import" text="Import" stern="true" />
                    <x-ag.input-file type="file" id="import" wire:model="import" placeholder="Import" />
                </div>
                <div class="flex justify-end items-center mt-4">
                    <x-ag.buttonLink wire:loading.remove icon-left="fa-file-import" class="mr-4" text="Import"/>
                </div>
                <div wire:loading wire:target="importUpload" class="flex justify-center items-center">
                    <div class="text-center">
                        <div role="status">
                            <svg aria-hidden="true" class="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="currentColor"/>
