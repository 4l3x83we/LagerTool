<div>
    ...
    <x-ag.header-admin current-page="Settings" current-text="Settings Vehicle Data" current-route="admin.settings.fahrzeugdaten" :pages="$pages">
            ...
            <x-ag.table>
                <x-slot:thead>
                    <tr>
                        ...
                        <th class="px-6 py-2">Fahrzeugtype</th>
                ...
                <x-slot:tbody>
                    @foreach($fdhs as $fdh)
                        <x-ag.tr>
                            ...
                            <td class="px-6 py-2">{{ $fdh->fdh_type }}</td>
                            <td class="px-6 py-2">{{ $fdh->fdh_ps . ' PS (' . $fdh->fdh_kw . ' kW)' }}</td>
                            <td class="px-6 py-2">{{ $fdh->fdh_hubraum . ' ccm³' }}</td>
