                ...
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    @foreach($permissions as $item)
                        <div class="flex items-center mb-2">
                            <input id="role-{{ $item->id }}" wire:model="permission.{{ $item->name }}" value="{{ $item->name }}" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
